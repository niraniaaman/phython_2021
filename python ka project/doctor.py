...
class doctor:
    def __init__(self,root):
        ...
        self.doctorspecialtext=StringVar()
        ...
        self.doctorspecial_entryblock=Entry(frame_doctorspecial,bg="lightgrey",font=("times new roman",15),textvariable=self.doctorspecialtext,borderwidth=4,relief=GROOVE)
    ...
    def get_cursor(self,event=" "):
        ...
        rows=content["values"]
        self.doctorspecialtext.set(rows[1])
