...
class homepage:
    def __init__(self,root):
        ...
        self.bg=PhotoImage(file="D:\python ka project\images\home1.png")
        ...
        cur=conn.cursor()
        cur.execute("select count(specialization) from specialization")
        self.a=cur.fetchall()
        ...
        conn=pymysql.connect(host="localhost",user="root",password="Amandeep@14454",database="hospital")
        cur=conn.cursor()
        cur.execute("select count(doctor_name) from doctor")
        self.b=cur.fetchall()
        ...
        conn=pymysql.connect(host="localhost",user="root",password="Amandeep@14454",database="hospital")
        cur=conn.cursor()
        cur.execute("select count(patient_name) from patient")
        self.c=cur.fetchall()
        ...
        conn=pymysql.connect(host="localhost",user="root",password="Amandeep@14454",database="hospital")
        cur=conn.cursor()
        cur.execute("select count(patient_name) from patient where apt_date=current_date")
        self.d=cur.fetchall()
    ...
    def logout(self):
        self.msgbox=messagebox.askyesno("warning","ARE YOU SURE",parent=self.root)
        if self.msgbox=='yes':
            self.root.destroy()
            import login
